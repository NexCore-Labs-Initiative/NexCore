...
const behaviorHooks = [
  ...
  ".command-main{grid-template-columns:repeat(2,minmax(0,1fr));gap:0 12px}",
  ".preview-panel{order:initial;padding:14px}",
  ".readiness-items{grid-template-columns:repeat(2,minmax(0,1fr));gap:8px}",
